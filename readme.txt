=== CampTix TrustCard Payment Gateway ===
...
TrustCard Payment Gateway for the CampTix plugin

== Description ==

TrustCard Payment Gateway for the CampTix plugin.

You can read more about TrustCard at [trustpay.eu](http://trustpay.eu/)
...
1. Go to `Tickets -> Setup` in your WordPress admin area to set the currency and activate the TrustCard gateway.
